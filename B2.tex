...
\todo{More on standard osc}
\todo{Decoherence today}
\todo{Osc today, matching anything else but at higher E now}
...
\todo{CPT-V today, and a touch of CP perhaps. Include that we beat accelerators in standard osc during this project}
...
%     \centering
% 		\includegraphics[width=1.\linewidth]{images/atmo_osc.png}
% 		\caption{Neutrinos produced in the atmosphere cross the Earth before detection in IceCube.}
% 		\vspace{-7pt}
% 		\label{fig:atmo_osc}
% \end{wrapfigure}
...
\todo{Need more specifics in this section?}
\todo{Need more on risks and mitigation}
...
% \begin{wrapfigure}{r}{0.4\textwidth} %this figure will be at the right
\begin{wrapfigure}{c}{0.4\textwidth} %this figure will be at the right
    \centering
    % \vspace{-7pt}
...
% Analysis A will be the \textbf{most comprehensive analysis of neutrino decoherence ever performed}, searching the GeV-PeV atmospheric neutrino flux detected by IceCube for signs of energy-dependent damping of neutrino oscillations (e.g. Fig. \ref{fig:oscillograms}) resulting from decoherence over distances up of up $\sim$12,700\,km (the Earth's diameter). This broad energy range maximises the sensitivity to many potential sources of decoherence. I will test the follow scenarios:
