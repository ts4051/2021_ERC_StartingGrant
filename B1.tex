...
% \todo{discuss that SM is often considered to be a low energy something of a theory of everything} at the energy and distance scales we can experimentally probe, only becoming large at the \textit{Planck scale}
...
% In these measurements I will quantity the impact of neutrino decoherence and $CPT$-V in IceCube via the comparison of simulated signals to the observed detector data. 
...
% The large statistical power of these measurements and weakness of the sought-after signals demand a robust treatment of systematic uncertainties to avoid biases. 
