...
%=======================================================================
%=======================================================================
\textbf{MOST IMPORTANT ACHIEVEMENTS ~~\hrulefill}\smallskip\\
%
\todo{References embedded here}
\todo{Be very technical}
\todo{Make clear main author works and works without PhD supervisor as co-author}
{\bf Neutrino decoherence phenomenology} \\ 
I developed new models of neutrino propagation in the presence of quantum gravity, and demonstrated these signals could be tested with atmospheric neutrino experiments. This is the first work to quantitively connect the microscopic properties of space-time to neutrino decoherence experimental signatures. These models are the first to directly connect the potentially observable phenomenology of neutrino decoherence to the underlying microphysics of a quan- tum theory of gravity, allowing experimental constraints on the fundamental nature of space-time to be made using decoherence measurements for the first time in this project.

{\bf World leading neutrino oscillation measurements with IceCube} \\ 
I lead the current neutrino oscillation measurements by the IceCube collaboration, producing the world’s most sensitive measurement of tau neutrino oscillations (2.5x the previous world best). Seven new measurements will shortly result from this.

{\bf IceCube Upgrade} \\ 
I lead the analyses demonstrating the physics potential of the IceCube Upgrade, resulting in the successful \$37 million funding of this next-generation detector. 

{\bf Measurement of the anomalous magnetic momentum of the muon} \\ 
I developed the low level data analysis methods and all the readout software for the tracking detector at Fermilab muon g-2. The first results (released next month) show strong evidence of new physics in the magnetic properties of muons.
